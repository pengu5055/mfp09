...
t_points = np.linspace(0, 0.15, N)
# Set diffusion constant
D = 1e-3

solver = ColocationSolver(gaussian_Initial, x_range, N, t_points, D)
solver.solve_Manually()
solver.plot_Lines(method="manual")
solver.plot_Heatmap(method="manual")
